 ...
 * 
 */
public class GUIThemCuDanKTX extends javax.swing.JDialog {
     ...
     */
    public GUIThemCuDanKTX(java.awt.Frame parent, boolean modal, Phong phongKTX) {
        super(parent, modal);
        ...
        model.setColumnIdentifiers(new Object[] {
            "Mã cư dân", "Họ và tên", "Giới tính", "Ngày sinh"
        });
    }
    ...
    private void timKiemHandler() {
        ...
        if(msv.trim().equals("") || msv == null) {
            JOptionPane.showMessageDialog(rootPane, "Yêu cầu nhập mã cư dân để tìm kiếm");
            return;
        }
        
        boolean flag = false;
        List<DanCu> list = new SINHVIENDOC().docfile();
        model.setRowCount(0);
        for (DanCu sv : list) {
        ...
        if(!flag) {
            JOptionPane.showMessageDialog(rootPane, "Không tìm thấy cư dân trên!!!");
    ...
    private void themSinhVienHandler() {
        ...
        if(viTri.length == 0) {
            JOptionPane.showMessageDialog(rootPane, "Hãy chọn cư dân muốn thêm!");
        } else if(viTri.length > 1)  {
            JOptionPane.showMessageDialog(rootPane, "Chỉ được chọn 1 cư dân dể thêm!");
        } else if(choTrong == 0)  {
            ...
            if(KhuDanCuService.daThuocKTX(msv)) {
                JOptionPane.showMessageDialog(rootPane, "Cư dân này đã đăng ký phòng trước đó!!!");
                return;
            }
            ...
            if(!Check.checkDateFormat(ngayHetHan)) {
                ...
                if (response == JOptionPane.YES_OPTION) {
                    CuDanKhuChungCu svMoi = new CuDanKhuChungCu(msv, name, gender, dateOfBirth, ngayDangKy, ngayHetHan);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUIThemCuDanKTX.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
