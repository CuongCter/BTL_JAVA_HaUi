...
import Service.KhuDanCuService;
...
public class GUIPhong extends javax.swing.JFrame {
    private Phong phongKTX;
    private DefaultTableModel model;

    /**
     * Creates new form Demo
     */
    public GUIPhong(Phong phongKTX) {
        ...
        model.setColumnIdentifiers(new Object[] {
            "Mã dân cư", "Họ và tên", "Giới tính", "Ngày sinh", "Ngày đăng ký", "Ngày hết hạn"
        });
    ...
    private void reload() {
        model.setRowCount(0);
        for (CuDanKhuChungCu sv : this.phongKTX.getDsSV()) {
        ...
        jLabel6.setText("Số cư dân hiện tại: " + phongKTX.getSoSVHienTai());
        jLabel5.setText("Số cư dân tối đa: " + phongKTX.getSoSVToiDa());
    ...
    private void xoaSinhVienHandler() {
        ...
        if(this.phongKTX.getDsSV().size() == 0) {
            JOptionPane.showMessageDialog(rootPane, "Phòng hiện tại không có cư dân nào!");
        } else if(viTriXoa.length == 0) {
            JOptionPane.showMessageDialog(rootPane, "Hãy chọn 1 dòng  muốn xóa!");
        } else {
    ...
    private void giaHanHandler() {
        ...
        if(this.phongKTX.getDsSV().size() == 0) {
            ...
            JOptionPane.showMessageDialog(rootPane, "Hãy chọn 1 dòng cư dân muốn gia hạn thêm thời gian!");
        } else {
            CuDanKhuChungCu svTagert = this.phongKTX.getDsSV().get(viTri[0]);
    ...
    private void suaPhongHandeler() {
        DialogSuaPhong dialogSuaPhongKTX = new DialogSuaPhong(this, rootPaneCheckingEnabled, this.phongKTX);
    ...
    private void themSinhVienHandler() {
        GUIThemCuDanKTX hihi = new GUIThemCuDanKTX(this, rootPaneCheckingEnabled, this.phongKTX);
    ...
    public void dispose() {
        try {
            KhuDanCuService.updateFile(phongKTX);
        } catch (IOException e) {
            e.printStackTrace();
        }
        super.dispose();
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Số người tối đa: " + phongKTX.getSoSVToiDa());
        ...
        jLabel1.setText("Danh sách cư dân hiện tại đang ở");

        xoaSinhVien.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        xoaSinhVien.setText("Xóa ");
        ...
        themSinhVienButton.setText("Thêm ");
        ...
        dsSVTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã cư dân", "Họ và tên", "Giới tính", "Ngày sinh", "Ngày đăng ký", "Ngày hết hạn"
            }
        ));
        dsSVTable.setRowHeight(25);
        jScrollPane1.setViewportView(dsSVTable);
        if (dsSVTable.getColumnModel().getColumnCount() > 0) {
            dsSVTable.getColumnModel().getColumn(0).setHeaderValue("Mã cư dân");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
               try {
                new GUIPhong(
                    KhuDanCuService.getPhongKTXById(KhuDanCuService.getListPhongFromFile(), "201")
                   ).setVisible(true);
