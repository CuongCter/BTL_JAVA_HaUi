...
import static Services.LichThiService.SVFromFile;
import static Services.LichThiService.getListSVById;
 ...
 * @author Đặng Huy
 */
public class ThemThiSinh extends javax.swing.JFrame {
    ...
    public ThemThiSinh(List listMaSV, LichThi lichthiFromParent, List<LichThi> list, ThiSinh tsScreen) {
        initComponents();
    ...
    private void showTableData() {
        ...
        List<SinhVien> listShow = new ArrayList<>();
        listShow = listSV;
        List<SinhVien> listExists = new ArrayList<>();
