 ...
 * 
 */
public class QuanLyDanCu extends javax.swing.JFrame {
...
public void initTable(){
        ...
        tblModel.setColumnIdentifiers(new String[]{"Mã dân cư","Họ tên","Giới tính","Ngày sinh","Quê quán"});
        tbSinhVien.setModel(tblModel);
        
    }
    public void loadDataToTable(){
        try {
            DanCuDAO dao=new DanCuDAO();
            List<DanCu> list=dao.docFile();
    ...
    private void btnTimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTimActionPerformed
        ...
        DataValidator.validateEmpty(txtSearchMSV, sb, "Mã dân cư không được để trống");
        if(sb.length()>0){
        ...
        try {
            DanCuDAO dao=new DanCuDAO();
            List<DanCu> list=dao.docFile();
            DanCu tv=dao.getSVbyMaSV(txtSearchMSV.getText(), list);
            if(tv!=null){
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        StringBuilder sb=new StringBuilder();
        DataValidator.validateEmpty(txtMSV, sb, "Mã dân cư không được để trống");
        DataValidator.validateEmpty(txtTenSV, sb, "Họ và tên không được để trống");
        DataValidator.validateEmpty(txtDOB, sb, "Ngày sinh không được để trống");
        DataValidator.validateEmpty(txtKhoa, sb, "Tên tòa không được để trống");
        if(sb.length()>0){
            MessageDialog.showErrorMessage(this, sb.toString(), "Lỗi");
            return;
        }
        if(MessageDialog.showConfirm(this, "Bạn có muốn sửa không", "Hỏi") == JOptionPane.NO_OPTION){
            return;
        }
        try {
            DanCuDAO dao=new DanCuDAO();
            List<DanCu> list=dao.docFile();
            DanCu newSV = new DanCu();
            ...
            if(dao.suaThanhVien(txtMSV.getText(), newSV, list)){
                MessageDialog.showMessage(this, "Đã được sửa", "Thông báo");
            }
            else{
                MessageDialog.showMessage(this, "Chưa được sửa", "Cảnh báo");
            }
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        ...
        if(MessageDialog.showConfirm(this, "Bạn có muốn xóa cư dân này không không", "Hỏi") == JOptionPane.NO_OPTION){
            return;
        }
        try {
            DanCuDAO dao = new DanCuDAO();
            ...
            if(dao.xoaThanhVien(txtMSV.getText(), list)){
                MessageDialog.showMessage(this, "Cư dân đã được xóa", "Thông báo");
            }
            else{
                MessageDialog.showMessage(this, "Cư dân chưa được xóa", "Cảnh báo");
            }
            dao.luuFile(list,false);
            loadDataToTable();
    ...
    private void btnLuuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLuuActionPerformed
        ...
        try {
            ...
            DanCu sv = new DanCu(txtMSV.getText(), txtTenSV.getText(), txtKhoa.getText(), txtDOB.getText(), btnNam.isSelected()?"nam":"nữ");
            list.add(sv);
            dao.luuFile(list,true);
            MessageDialog.showMessage(this, "Cư dân đã được lưu", "Thông báo");
            loadDataToTable();
    ...
    private void tbSinhVienMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbSinhVienMouseClicked
        try {
            ...
            if(row>=0){
                ...
                DanCuDAO dao=new DanCuDAO();
                List<DanCu> list=dao.docFile();
                DanCu tv=dao.getSVbyMaSV(id, list);
                if(tv!=null){
                    txtMSV.setText(tv.getMaSV());
                    txtTenSV.setText(tv.getTenSV());
                    txtDOB.setText(tv.getNgaySinh());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QuanLyDanCu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
