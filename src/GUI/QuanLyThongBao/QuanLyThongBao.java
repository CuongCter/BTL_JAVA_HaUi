...
import GUI.Home;
import static Services.ThongBaoService.lichThiFromFile;
 ...
 * 
 */
public class QuanLyThongBao extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tableLichThi.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Tên thông báo", "Nội dung", "Ngày", "Thời gian", "Tổ chức", "Địa điểm", "Số lượng"
            }
        ) {
        ...
        bntThemLich.setText("Thêm thông báo");
        ...
        btnCapNhat.setText("Cập nhật thông báo");
        ...
        btnXoaLich.setText("Xóa thông báo");
        ...
        txtKyThi.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Họp dân cư", "Tổng vệ sinh", "Đánh giá thường xuyên", "Giao lưu văn nghệ", "Thể dục thể thao" }));
    ...
    private void btnThiSinhActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThiSinhActionPerformed
        ...
        if (selectedIndex == -1) {
            JOptionPane.showMessageDialog(this, "Hãy chọn một thông báo để cập nhật cư dân!", "Cảnh báo", JOptionPane.WARNING_MESSAGE);
        } else {
            ChiTietThongBao thisinh = new ChiTietThongBao(list.get(selectedIndex).getListSV(), list.get(selectedIndex), list);
    ...
    private void btnXoaLichActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaLichActionPerformed
        ...
        if (selectedRows.length <= 0) {
            ...
            if (confirm == JOptionPane.YES_OPTION) {
                List<ThongBao> needToRemove = new ArrayList<>();
    ...
    private void bntThemLichActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntThemLichActionPerformed
        if (checkIsEmpty()) {
            ...
            try {
                if (checkExists()) {
                    JOptionPane.showMessageDialog(this, "Thông báo này đã tồn tại trên hệ thống!", "Lỗi", JOptionPane.ERROR_MESSAGE);
                } else {
                    ...
                    ThongBao lich = new ThongBao(tenKyThi, monThi, ngayThi, caThi, phongThi, diemThi, listSV);
                    list.add(lich);
                    showTableData();
                    clearContent();
                    writeFile(fileName, list);
    ...
    private void tableLichThiMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableLichThiMouseClicked
        ...
        if (outOfDate(list.get(selectedIndex).getNgayThi())) {
            int confirm = JOptionPane.showConfirmDialog(this, "Thông báo đã quá hạn. Xác nhận xóa?", "Xác nhận xóa", JOptionPane.INFORMATION_MESSAGE);
            if (confirm == JOptionPane.YES_OPTION) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QuanLyThongBao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
