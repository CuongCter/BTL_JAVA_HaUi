...
public class DANHGIASCREEN1 extends javax.swing.JFrame {
    ...
    static String Masv;
    static String Hoten;
    static List<DanhGia> DGList = new ArrayList<DanhGia>();

    public DANHGIASCREEN1(DanhGia dgsv, List<DanhGia> listsv) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel18.setText("5. Đánh giá về ý thức tham gia công tác cán bộ lớp,tổ chức trong khu dân cư hoặc đạt được các thành tích xuất sắc (0-20đ)");

        jLabel8.setFont(new java.awt.Font("Segoe UI", 0, 13)); // NOI18N
        jLabel8.setText("- Có lối sống lành mạnh, tích cực , tuân thủ pháp luật (0-10đ)");
        ...
        jLabel10.setText("- Chấp hành các quy định, các văn bản chỉ đạo được ban hành bởi nhà nước (0-10đ)");
        ...
        jLabel11.setText("- Chấp hành các nội quy, quy chế của khu dân cư(0-10đ)");
        ...
        jLabel12.setText("- Chấp hành các quy định khác được thực hiện trong các khu tập thể(0-5đ)");

        jLabel13.setFont(new java.awt.Font("Segoe UI", 0, 13)); // NOI18N
        jLabel13.setText("2.Đánh giá về ý thức chấp hành nội quy quy chế của khu dân cư");

        jLabel3.setFont(new java.awt.Font("Segoe UI", 0, 13)); // NOI18N
        jLabel3.setText("- Bảo vệ giữ gìn vệ sinh chung (0-5đ)");

        jLabel4.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        jLabel4.setText("- Là thành viên các CLB, hoạt động đoàn thể (0-3đ)");

        jLabel5.setFont(new java.awt.Font("Segoe UI", 0, 13)); // NOI18N
        jLabel5.setText("- Tham gia các cuộc thi phong trào(0-5đ)");
        ...
        jLabel2.setText("1.Đánh giá về ý thức, thái độ tham gia và lối sống tại nơi cư trú ");
        ...
        jLabel15.setText("- Là thành viên và sinh hoạt định kỳ cùng các CLB và hoạt động đoàn thể (0-5đ)");

        jLabel6.setFont(new java.awt.Font("Segoe UI", 0, 13)); // NOI18N
        jLabel6.setText("-Tham gia các lớp kỹ năng mềm, kỹ năng thực hành xã hội được nhà nước tổ chức(0-8đ) ");
        ...
        jLabel7.setText("- Đảm bảo an ninh trật tự (0-4đ)");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        for (DanhGia danhgiasinhvien : DGList) {
